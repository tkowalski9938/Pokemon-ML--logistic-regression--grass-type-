# Pokemon ML Algorithm, Grass Type or Not (LR)
...
grass type or not (1 or 0, respectively). I focused on vectorization in this project, ensuring that the entire training set was processed per iteration.
